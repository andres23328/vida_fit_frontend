...
function App() {
    ...
    const [correo, setUser] = useState(null);
    ...
    const getRecommendations = async (userData) => {
        try {
            ...
            // Guardar estos datos en el estado y mostrarlos en la interfaz
            setImc(imc);
            setUser(correo);
    ...
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route path="/imc" element={<IMCPage imc={imc} correo={correo} contraseña={contraseña} />} />
